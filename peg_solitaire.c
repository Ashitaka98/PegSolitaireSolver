...
int main(int argc, char *argv[]) {
	...
	if( ai_run ){ 
		...
		print_solution( );
		printf("STATS: \n");
		printf("\tExpanded nodes: %d\n\tGenerated nodes: %d\n", explored_nodes, generated_nodes);
		printf("\tSolution Length: %d\n", solution_size);
		printf("\tNumber of Pegs Left: %d\n", num_pegs( &(solution[solution_size]) ) );
		printf("\tExpanded/seconds: %d\n", (int)(explored_nodes/cpu_time_used) );
		printf("\tTime (seconds): %f\n", cpu_time_used );

		FILE *f = fopen("output.txt","w");
		fprintf(f,"STATS: \n");
		fprintf(f,"\tExpanded nodes: %d\n\tGenerated nodes: %d\n", explored_nodes, generated_nodes);
		fprintf(f,"\tSolution Length: %d\n", solution_size);
		fprintf(f,"\tNumber of Pegs Left: %d\n", num_pegs( &(solution[solution_size]) ) );
		fprintf(f,"\tExpanded/seconds: %d\n", (int)(explored_nodes/cpu_time_used) );
		fprintf(f,"\tTime (seconds): %f\n", cpu_time_used );
